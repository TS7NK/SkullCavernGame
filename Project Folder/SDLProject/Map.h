...
public:
    ...
    tile_count_x, int tile_count_y,int map_type);
    
    // Methods
    void build();
    void render(ShaderProgram *program);
    bool is_solid(glm::vec3 position, float *penetration_x, float *penetration_y, int whichfloor);
    void update_level_data(unsigned int* new_level_data);
